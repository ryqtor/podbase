...
class ProviderFactory:
    ...
    def create_provider(
        ...
        elif provider_str in ("demo", "mock"):
    ...
    async def get_provider(
        ...
        2. Try alternate external provider (Ollama / OpenAI)
        3. Fallback to built-in DemoProvider (guarantees system availability)
        """
        ...
        try:
            ...
            logger.warning("primary_provider_check_failed", provider=provider_name, error=str(e))
    ...
    async def list_available_models() -> list[dict]:
        ...
        # Built-in Lenny Growth intelligence engine is always available
        models.append({
            "provider": "demo",
            "model": "lenny-growth-engine",
            "status": "available",
        })
